...
_CONNECTED_GENARATORS = ['Quantum 9520', 'Stanford DG535']
_AVAILABLE_CHANNELS = {'Quantum 9520': ["A", "B", "C", "D", "E", "F", "G", "H"],
...
class DelayPanel(QGroupBox):
    def __init__(self, device_manager, parent=None):
        ...
        for generator in _CONNECTED_GENARATORS:
            layout.addWidget(self._DelayGenBox(generator))
    ...
    class _DelayGenBox(QGroupBox):
        ...
        def get_settings(self):
            ...
            return {
                ch: (self.delay_spinboxes[ch].value(), self.ref_comboboxes[ch].currentText())
